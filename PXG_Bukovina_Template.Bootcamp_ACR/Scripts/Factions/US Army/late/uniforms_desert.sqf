...
// add helmet
switch (_loadout) do {
	default { player addHeadgear "rhsusf_lwh_helmet_marpatd"};
	case "plt";
	case "logi";
	case "sqd_eng";
	case "tacp": { player addHeadgear "rhsusf_lwh_helmet_marpatd_headset"};
	case "sqd_ar";
	case "sqd_aar";
	case "sup_mmg_l";
	case "sup_mmg_g";
	case "sqd_gre": { player addHeadgear "rhsusf_lwh_helmet_marpatd_ess"};
